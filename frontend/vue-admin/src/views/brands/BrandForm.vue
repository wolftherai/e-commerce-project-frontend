...
name: "BrandForm",
    ...
    async mounted() {
        ...
        {
            const {data} = await this.$http.get(`brands/${this.$route.params.id}`);
    ...
    methods: {
        ...
        async submit() {
            ...
            if (this.$route.params.id) { // if id exists
                await this.$http.put(`brands/${this.$route.params.id}`,data) // update product
            }
            else {
                await this.$http.post('brands',data) // create product
            }
